...
if [[ $REPLY =~ ^[Yy]$ ]]; then
    ...
    curl -s https://raw.github.com/urda/urda.bash/master/bashrc > ~/.bashrc

    echo "Downloading .bash_aliases ..."
    curl -s https://raw.github.com/urda/urda.bash/master/bash_aliases > ~/.bash_aliases

    echo "Downloading .bash_exports ..."
    curl -s https://raw.github.com/urda/urda.bash/master/bash_exports > ~/.bash_exports
